      ...
      >
        ...
        {editing ? (
          <input
            ...
            className="w-full text-center text-2xl font-bold text-blue-600 bg-transparent focus:outline-none tabular-nums"
            maxLength={2}
          />
        ) : (
          ...
          >
                              ...
                              return (
                                <motion.button
                                  ...
                                  className={`flex-1 h-8 rounded-lg text-[11px] font-bold transition-all ${
                                    isDaySelected
                                      ? isSun ? 'bg-red-500 text-white' : isSat ? 'bg-blue-500 text-white' : 'bg-indigo-500 text-white'
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex gap-3">
              ...
              <motion.button
                ...
                className="flex-2 px-8 py-2.5 bg-blue-500 text-white rounded-xl text-sm font-semibold hover:bg-blue-600 transition-colors disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed shadow-md shadow-blue-200"
              >
                {selectedDate
