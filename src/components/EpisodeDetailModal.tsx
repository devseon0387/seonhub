...
import { X, Edit2, Plus, Calendar, DollarSign, ChevronDown, ChevronRight } from 'lucide-react';
                                  ...
                                  <div className="grid grid-cols-2 gap-3 mb-3">
                                    ...
                                    <div>
                                      ...
                                      <input
                                        ...
                                        placeholder="예: 1차 종편"
                                        className="w-full text-sm px-3 py-2 border border-gray-200 rounded focus:border-blue-300 focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white"
                                      />
                                    </div>
                                  ...
                                  <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <div>
                                      ...
                                      <select
                                        ...
                                        className={`w-full text-sm px-3 py-2 rounded border-0 focus:outline-none focus:ring-1 focus:ring-blue-500 cursor-pointer font-medium ${getStatusColor(step.status)}`}
                                      >
