                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative">
                    <motion.button
                      ...
                      className={`text-sm font-semibold px-3 py-1.5 rounded-full transition-colors ${
                        selecting === 'end' ? 'bg-blue-500 text-white' : 'bg-blue-50 text-blue-400 hover:bg-blue-100'
                  ...
                  <AnimatePresence>
                    {selecting === 'end' && startDate && (
                      <motion.button
                        ...
                        className="text-xs font-semibold px-3 py-1.5 rounded-full border border-blue-200 text-blue-500 hover:bg-blue-50 transition-colors"
                      >
                        미정
                      </motion.button>
                    )}
    ...
    return (
      <div>
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-1">
          ...
          >
            <Calendar size={12} className={`flex-shrink-0 ${formatShort(startDate) ? 'text-blue-500' : 'text-gray-400'}`} />
          ...
          >
            <Calendar size={12} className={`flex-shrink-0 ${endDate === 'tbd' ? 'text-blue-400' : endDate ? 'text-blue-500' : 'text-gray-400'}`} />
            <span className={`truncate tabular-nums ${endDate === 'tbd' ? 'text-blue-500 font-medium' : endDate ? 'text-blue-800 font-medium' : 'text-gray-400'}`}>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <Calendar size={16} className={endDate === 'tbd' ? 'text-blue-400' : endDate ? 'text-blue-500' : 'text-gray-400'} />
          <span className={endDate === 'tbd' ? 'text-blue-500 font-medium text-sm' : endDate ? 'text-blue-800 font-medium text-sm' : 'text-gray-400 text-sm'}>
