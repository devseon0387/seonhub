  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <p className="text-xs text-gray-400 mb-0.5">총 정산 금액</p>
              ...
              <div key={date} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[750px]">
                    <div className="px-5 py-2 bg-gray-50 grid grid-cols-[minmax(140px,1.5fr)_55px_minmax(120px,1.5fr)_auto_110px_110px_60px] gap-3 text-[11px] font-semibold text-gray-400 border-b border-gray-100">
                      <span>프로젝트</span>
                      <span className="text-center">회차</span>
                      <span>제목</span>
                      <span>작업 내용</span>
                    ...
                    <div className="divide-y divide-gray-50">
                      {items.map(({ episode: ep, project }) => {
                        ...
                        return (
                          <div key={ep.id} className="px-5 py-3 grid grid-cols-[minmax(140px,1.5fr)_55px_minmax(120px,1.5fr)_auto_110px_110px_60px] gap-3 items-center hover:bg-gray-50 transition-colors">
                            <span className="text-sm text-gray-700 whitespace-nowrap">{project.title}</span>
                            <span className="text-sm text-orange-500 font-semibold text-center">{ep.episodeNumber}편</span>
                            <span className="text-sm text-gray-500 whitespace-nowrap">{ep.title || '-'}</span>
                    ...
                    {/* 날짜 소계 */}
                    <div className="px-5 py-3 bg-gray-50 border-t border-gray-100 grid grid-cols-[minmax(140px,1.5fr)_55px_minmax(120px,1.5fr)_auto_110px_110px_60px] gap-3 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-5 py-4 flex items-center justify-between">
            {(partner.bank && partner.bankAccount) ? (
              ...
              >
                ...
                <span className="text-gray-600">{partner.bank} {partner.bankAccount}</span>
                {copiedId ? (
