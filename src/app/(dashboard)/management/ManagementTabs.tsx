...
export default function ManagementTabs({ initialData, todayLabel }: Props) {
    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">{todayLabel}</p>
        </div>
      ...
      <div className="relative">
        <AnimatePresence mode="wait" initial={false}>
          ...
          >
            {activeTab === 'main' ? (
              <ManagementMain initialData={initialData} />
            ) : activeTab === 'missing' ? (
