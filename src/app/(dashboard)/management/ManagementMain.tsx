      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_560px] gap-4 relative">
        ...
        <div className="bg-white rounded-2xl border border-ink-100 p-4 sm:p-5">
          ...
          <div className="mb-5">
            ...
            <div className="ml-4 border-l-2 border-blue-200 pl-3.5 flex flex-col gap-1.5">
            ...
            >
              ...
              <div className="px-5 pb-4">
                <input
                  ...
                  className="w-full text-base text-ink-900 placeholder-gray-300 focus:outline-none bg-transparent border-b-2 border-ink-100 focus:border-blue-400 pb-2 transition-colors"
                />
              </div>
                  ...
                  <div className={`inline-flex items-center gap-2 text-sm px-3 py-1.5 rounded-lg transition-colors cursor-pointer ${newItemReminder ? 'text-brand-600 bg-brand-50' : 'text-ink-400 hover:text-ink-600 hover:bg-ink-50'}`}>
                    ...
                    {newItemReminder && (
                      <span
                        ...
                        className="ml-1 text-blue-400 hover:text-brand-600"
                      >
                        <X size={12} />
                      </span>
                    )}
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                {(formLink.episodeId || formLink.projectId || formLink.clientName || formLink.partnerId) && (
                  <div className="flex flex-wrap gap-2">
                    {formLink.episodeId && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-brand-50 text-blue-900 rounded-full text-xs font-medium border border-blue-200">
                        <Link2 size={11} /> {formLink.episodeNumber}회차 {formLink.episodeTitle}
                        <button onClick={() => clearLink('episode')} className="ml-0.5 hover:text-blue-950"><X size={11} /></button>
                      </span>
                    )}
                    {formLink.projectId && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-brand-50 text-blue-900 rounded-full text-xs font-medium border border-blue-200">
                        📁 {formLink.projectTitle}
                        {!formLink.episodeId && <button onClick={() => clearLink('project')} className="ml-0.5 hover:text-blue-950"><X size={11} /></button>}
                      </span>
                    )}
                    {formLink.clientName && (
                    ...
                    {formLink.partnerId && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-brand-50 text-blue-900 rounded-full text-xs font-medium border border-blue-200">
                        ...
                        {!formLink.projectId && <button onClick={() => clearLink('partner')} className="ml-0.5 hover:text-blue-950"><X size={11} /></button>}
                      </span>
                    )}
                  </div>
                )}
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {!formLink.episodeId && (
                    <button onClick={() => { setActiveLinkPicker('episode'); setLinkSearch(''); }}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs border border-ink-200 text-ink-500 hover:border-blue-300 hover:text-brand-600 hover:bg-brand-50 transition-all">
                      <Plus size={11} /> 회차 연결
                    </button>
                  )}
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 pt-5 pb-3">
                <div className="flex items-center gap-2">
                  {activeLinkPicker === 'episode' && <div className="w-6 h-6 rounded-md bg-blue-100 flex items-center justify-center"><span className="text-[10px] font-bold text-brand-600">EP</span></div>}
                  {activeLinkPicker === 'project' && <div className="w-6 h-6 rounded-md bg-blue-100 flex items-center justify-center"><span className="text-[10px] font-bold text-brand-600">P</span></div>}
                  ...
                  {activeLinkPicker === 'partner' && <div className="w-6 h-6 rounded-md bg-blue-100 flex items-center justify-center"><span className="text-[10px] font-bold text-brand-600">P</span></div>}
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              ...
                              {item.repeatType && item.repeatType !== 'none' && (
                                <span className="text-[10px] text-brand-500 bg-blue-100 px-1.5 py-0.5 rounded-full">
