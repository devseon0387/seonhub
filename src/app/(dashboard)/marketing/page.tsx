      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-800 transition-colors font-medium flex items-center gap-2"
          >
            <Plus size={20} />
            포트폴리오 추가
          </Link>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/marketing/portfolio"
              className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-800 transition-colors text-sm font-medium flex items-center gap-2"
            >
              포트폴리오 관리
        ...
        <div className="divide-y divide-gray-200">
          ...
          {!loading && portfolioItems.length > 5 && (
            <div className="p-4 text-center">
              <Link href="/marketing/portfolio" className="text-sm text-blue-800 hover:text-blue-900 font-medium">
